...
const MiniDelegateB2 = artifacts.require("MiniDelegateB2");
...
const deployApp = async (deployer) => {
  ...
  await deployer.deploy(MiniDelegateB2, IBCHandler.address);
};
...
const init = async (deployer) => {
  ...
  for(const promise of [
    ...
    () => ibcHandler.bindPort(PortTransfer, MiniDelegateB2.address),
